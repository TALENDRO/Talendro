...
import { type Address, Data, paymentCredentialOf, type UTxO } from "@lucid-evolution/lucid"
...
console.log("fecthing projects")
  ...
  useEffect(() => {
    ...
    async function loadProjects() {
      setIsLoading(true)
      await Promise.all([fetchProjects(PROJECTINITADDR), fetchProjects(HOLDINGADDR), fetchProjects(MILESTONEADDR)])
      setIsLoading(false)
    }
          ...
          <TabsContent value="client">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Projects you've created as a client</CardDescription>
              </CardHeader>
              <CardContent>
                {clientProjects.size > 0 ? (
                  ...
                  <p className="text-center text-muted-foreground">No client projects found.</p>
                )}
              </CardContent>
            </Card>
          </TabsContent>
          <TabsContent value="developer">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Projects you've accepted as a developer</CardDescription>
              </CardHeader>
              <CardContent>
                {devProjects.size > 0 ? (
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <p className="text-center text-muted-foreground">No developer projects found.</p>
                )}
              </CardContent>
            </Card>
          </TabsContent>
