import { IDENTIFICATIONPID, STAKEADDRESS, SYSTEMADDRESS, TALENDROPID } from "@/config";
...
import { Data, fromText, paymentCredentialOf, Validator } from "@lucid-evolution/lucid";
