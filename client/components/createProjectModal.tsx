...
import { Data, fromText, MintingPolicy, paymentCredentialOf } from "@lucid-evolution/lucid"
...
export function CreateProject() {
    ...
    async function createProject(title: string, pay: number | null, type: ProjectType) {
